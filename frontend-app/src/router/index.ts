  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "topics", name: "topics", component: () => import("@/views/TopicListView.vue") },
        { path: "topics/:slug", name: "topic-detail", component: () => import("@/views/TopicDetailView.vue"), props: true },
