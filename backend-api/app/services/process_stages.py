...
PROCESS_STAGES: tuple[ProcessStage, ...] = (
    ProcessStage("slurry", "制浆", "活性物质、导电剂、粘结剂与溶剂混合分散，形成稳定浆料。", ("制浆", "匀浆", "浆料", "分散", "粘度")),
    ProcessStage("coating", "涂布", "将浆料均匀涂覆在集流体上，并通过干燥控制面密度与一致性。", ("涂布", "涂覆", "极片", "干燥", "面密度", "厚度")),
    ProcessStage("calendering", "辊压", "通过辊压控制极片压实密度、孔隙率、厚度和反弹。", ("辊压", "压实", "压实密度", "孔隙率", "反弹")),
    ProcessStage("slitting", "分切", "将辊压后的极片按规格分切，控制毛刺、粉尘与边缘质量。", ("分切", "模切", "毛刺", "粉尘", "极耳")),
    ProcessStage("winding-stacking", "卷绕/叠片", "将正负极片与隔膜按结构装配成电芯芯包。", ("卷绕", "叠片", "隔膜", "芯包", "对齐度")),
    ProcessStage("assembly", "装配", "完成入壳、焊接、封装等电芯结构装配步骤。", ("装配", "入壳", "焊接", "封装", "顶盖")),
    ProcessStage("electrolyte-filling", "注液", "向电芯注入电解液并完成浸润，影响界面和循环表现。", ("注液", "电解液", "浸润", "静置", "真空")),
    ProcessStage("formation", "化成", "通过首次充放电形成稳定 SEI/CEI 界面。", ("化成", "SEI", "首次充电", "充放电", "温控")),
    ProcessStage("grading", "分容", "按容量、内阻、电压等指标对电芯进行分档。", ("分容", "容量", "内阻", "分档", "OCV")),
    ProcessStage("inspection", "检测", "通过外观、尺寸、电性能和安全检测筛选异常电芯。", ("检测", "测试", "外观", "尺寸", "缺陷", "X-ray", "安全")),
)
